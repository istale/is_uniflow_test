#!/usr/bin/env bash
# run_create_layout.sh
# Shell wrapper for create_layout.py following KLayout JSON I/O standard

echo "Starting KLayout script execution..."
...
KLAYOUT_SCRIPT="create_layout.py"
CAPTURE_FILE="${2:-}"
